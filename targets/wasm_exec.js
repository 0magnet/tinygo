			...
			this.importObject = {
				...
				gojs: {
					...
					"runtime.sleepTicks": (timeout) => {
						...
						// timeout, keeping exactly one pending wakeup. Arming a second
						// without cancelling the first leaks a self-sustaining timer
						// chain, because the callback schedules its own replacement.
